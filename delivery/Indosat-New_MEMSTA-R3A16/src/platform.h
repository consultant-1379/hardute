...
#define CPUCORESTAT_COMMAND		"mpstat -P ALL"
#define CPUCORESTAT_NAMES		{ "CPU", "%user","%sys", "%iowait", "%idle", 0 }
#define CPUCORESTAT_HTOKENS		{ " ", "\n", 0 }
#define CPUCORESTAT_DTOKENS		{ " ", "\n", 0 }
#define CPUCORESTAT_HEADERTOKEN ":"

#define DISKSTAT_COMMAND	"sar -d -p"
#define DISKSTAT_NAMES		{ "EV", "tps", "rd_sec/s", "wr_sec/s", "avgqu-sz", "await", "svctm", "%util", 0 }
#define DISKSTAT_HTOKENS	{ " ", "\n", 0}
#define DISKSTAT_DTOKENS	{ " ", "\n", 0}
#define DISKSTAT_HEADERTOKEN "D"
#define DISKSTAT_DATATOKEN	"Average:"

/* last E missing from "Average" because there are 3 header fields and "Average" is the first data field - solaris*/
#define MEMSTAT_COMMAND_KB	"free -k"
#define MEMSTAT_COMMAND_B	"free -b"
#define MEMSTAT_NAMES		{ "total", "used", "free", 0 }
#define MEMSTAT_HTOKENS		{ " ", "\n", 0 }
#define MEMSTAT_DTOKENS		{ " ", "\n", 0 }
#define MEMSTAT_HEADERTOKEN	" "
#define MEMSTAT_DATATOKEN_MEM	"Mem:"
#define MEMSTAT_DATATOKEN_SWAP	"Swap:"
